...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/busdramauk)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/busdramauk
```

A live public deployment of this template is available at [https://busdramauk.templates.workers.dev](https://busdramauk.templates.workers.dev)
